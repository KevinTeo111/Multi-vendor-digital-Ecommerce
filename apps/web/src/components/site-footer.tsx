...
export function SiteFooter() {
  ...
  const columns = [
    {
      title: t('nav.footerBrowse'),
      links: [
        { href: '/', label: t('nav.home') },
        { href: '/products', label: t('nav.browse') },
        { href: '/plans', label: t('nav.sellerPlans') },
      ],
    },
    {
      title: t('nav.footerSell'),
      links: [
        { href: '/register?role=VENDOR', label: t('nav.openStore') },
        { href: '/plans', label: t('nav.sellerPlans') },
      ],
    },
    {
      title: t('nav.footerAccount'),
      links: [
